defmodule WarehouseApiWeb.ProductController do
  use WarehouseApiWeb, :controller

  alias WarehouseApi.Inventory
  alias WarehouseApi.Inventory.Product

  action_fallback WarehouseApiWeb.FallbackController
